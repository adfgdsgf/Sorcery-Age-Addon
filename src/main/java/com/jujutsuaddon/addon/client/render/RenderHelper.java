...
public class RenderHelper {
    ...
    public static final class Colors {
        ...
        // ★★★ 封印状态颜色 ★★★
        public static final int TEXT_BANNED = 0xAA0000;  // 深红文字
        ...
        // ★★★ 封印状态背景 ★★★
        public static final int BG_BANNED = 0xFF200000; // 深红黑背景
        ...
        // ★★★ 封印状态边框 ★★★
        public static final int BORDER_BANNED = 0xFF550000;
    ...
    public static int getTextColor(boolean isDead, boolean techniqueNotActive,
                                   ...
                                   boolean summonConflict, boolean isBanned) {
        if (isBanned) return Colors.TEXT_BANNED;
    ...
    public static int getTextColor(boolean isDead, boolean techniqueNotActive,
        ...
        return getTextColor(isDead, techniqueNotActive, canUse, isActive, hasSummon, summonConflict, false);
    }
    ...
    public static int getIconBgColor(boolean isDead, boolean techniqueNotActive,
                                     boolean canUse, boolean isActive, boolean hasSummon,
                                     boolean summonConflict, boolean isBanned) {
        if (isBanned) return Colors.BG_BANNED;
    ...
    public static int getIconBgColor(boolean isDead, boolean techniqueNotActive,
                                     boolean canUse, boolean isActive, boolean hasSummon,
                                     boolean summonConflict) {
        return getIconBgColor(isDead, techniqueNotActive, canUse, isActive, hasSummon, summonConflict, false);
    }
    ...
    public static int getBorderColor(boolean isDead, boolean techniqueNotActive,
                                     ...
                                     boolean conditionsNotMet, boolean isBanned) {
        if (isBanned) return Colors.BORDER_BANNED;
        if (isActive || hasSummon) {
            return getPulsingActiveBorderColor();
        }
        if (isDead) return Colors.BORDER_DEAD;
        if (conditionsNotMet) return Colors.BORDER_CONDITIONS_NOT_MET;
    ...
    public static int getBorderColor(boolean isDead, boolean techniqueNotActive,
                                     boolean canUse, boolean isActive, boolean hasSummon,
                                     boolean summonConflict, boolean playerOwns,
                                     boolean conditionsNotMet) {
        return getBorderColor(isDead, techniqueNotActive, canUse, isActive, hasSummon, summonConflict, playerOwns, conditionsNotMet, false);
    }
    ...
    public static int getSlotBgColor(boolean isDead, boolean techniqueNotActive,
                                     ...
                                     boolean conditionsNotMet, boolean isBanned) {  // 第10个参数
        if (isBanned) return 0xCC200000; // 明显的深红色背景
        if (conditionsNotMet) return 0x80443300;
    ...
    public static int getSlotBgColor(boolean isDead, boolean techniqueNotActive,
                                     ...
                                     boolean canUse, boolean onCooldown,
                                     boolean conditionsNotMet) {
        return getSlotBgColor(isDead, techniqueNotActive, isActive, hasSummon, summonConflict, playerOwns, canUse, onCooldown, conditionsNotMet, false);
    }
    ...
    public static int getSlotBorderColor(boolean isActive, boolean hasSummon,
                                         ...
                                         boolean conditionsNotMet, boolean isBanned) {  // ★ 新增参数
        if (isBanned) return 0xFFAA0000; // 鲜红色边框
        if (isActive || hasSummon) return getPulsingActiveBorderColor();
        if (conditionsNotMet) return 0xFFFF8800;
    ...
    public static int getSlotBorderColor(boolean isActive, boolean hasSummon,
                                         ...
                                         boolean playerOwns, boolean usable,
                                         boolean conditionsNotMet) {
        return getSlotBorderColor(isActive, hasSummon, techniqueNotActive, summonConflict, playerOwns, usable, conditionsNotMet, false);
    }
